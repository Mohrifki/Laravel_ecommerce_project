        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">Edit Main Categories</div>
                            <hr />
                            <form method="POST" action="{{ route('main_category.update', $main_category->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="form-group row">
                                    <label for="input-21" class="col-sm-2 col-form-label">Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="name" value="{{ $main_category->name }}" class="form-control" id="input-21" />
                                    </div>
                                </div>
