...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            @include('admin.includes.bread_cumb',['title'=>'All Color'])
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h5 class="card-title">Colors</h5>
                            <a href="{{ route('color.create') }}" class="btn btn-warning"><i class="fa fa-plus"> ADD</i></a>
                        </div>
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td scope="row">
                                                    <div class="text-right">
                                                        ...
                                                        <a type="button" href="{{ route('color.destroy',$item->id) }}"
