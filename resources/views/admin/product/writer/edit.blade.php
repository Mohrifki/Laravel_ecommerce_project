                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" class="update_form" action="{{ route('writer.update', $writer->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="name" value="{{ $writer->name }}" class="form-control" id="input-21" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="description" class="form-control" id="mytextarea" cols="30" rows="10">{!! $writer->description !!}</textarea>
