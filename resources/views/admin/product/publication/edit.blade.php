                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" class="update_form" action="{{ route('publication.update', $publication->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="name" value="{{ $publication->name }}" class="form-control" id="input-21" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="description" class="form-control" id="mytextarea" cols="30" rows="10">{!! $publication->description !!}</textarea>
                                        {{-- <input type="text" name="desription" class="form-control" id="input-21" /> --}}
