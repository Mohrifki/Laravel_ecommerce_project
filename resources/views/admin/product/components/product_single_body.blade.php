<div class="col admin_product_individual_body">
  <div class="card position-relative">
      ...
      <div class="card-body">
          <h6 class="card-title cursor-pointerd-block">{{ $product->name }}</h6>
          <div class="clearfix d-flex justify-content-between">
              <p class="mb-0"><strong>134</strong> Sales</p>
              <p class="mb-0 fw-bold">
                  <span class="me-2 text-decoration-line-through"><del> Rp.{{ $product->price }}</del></span>
                  <span class="text-white">Rp {{ Helper::discount_price($product->price, $product->discount) }},-</span>
              </p>
          </div>
      ...
      <div class="card-footer">
          <ul class="d-flex flex-wrap justify-content-center" style="padding-right: 12px">
