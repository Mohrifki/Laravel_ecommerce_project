<ul class="metismenu" id="menu">
    <li>
        ...
        <ul class="">
            <li>
                <a href=""><i class="zmdi zmdi-dot-circle-alt"></i> eCommerce</a>
            </li>
        </ul>
    </li>
    ...
    <li>
        <a  href="{{ route('logout') }}" 
            onclick="event.preventDefault(); confirm('do you want logout?') && document.getElementById('logout-form').submit();">
